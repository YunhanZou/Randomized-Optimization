...
public class phishing_nn_SA {
    ...
    public static void main(String[] args) {
        ...
        int[] iterations = {500,500,500,500,500,500};
        //int[] iterations = {500};

        double[] coolings = {0.05, 0.1, 0.2, 0.35, 0.5, 0.65, 0.8, 0.95};
		// double[] temperatures = {1e1,1e2,1e3,1e4,1e5,1e6,1e7};
        double[] temperatures = {1e4, 1e4, 1e4, 1e4, 1e4, 1e4, 1e4};
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/PhishingWebsitesData_preprocessed.csv")));
